...
sleep 5
xterm  -e  " source /opt/ros/kinetic/setup.bash; source /home/shimon/udacity-robotics/catkin_ws/devel/setup.bash; rosrun pick_objects pick_objects " &
xterm  -e  " source /opt/ros/kinetic/setup.bash; source /home/shimon/udacity-robotics/catkin_ws/devel/setup.bash; rosrun add_markers add_markers " 
